...
public class DashboardController : Controller
{
    ...
    readonly DateTime previousMounthStartDate = new(DateTime.Now.Year, previousMonth, 1);
    readonly DateTime currentMounthStarDate = new(DateTime.Now.Year, DateTime.Now.Month, 1);
    ...
    public async Task<IActionResult> GetTotalBookingRadialChartData()
    {
        ...
        var countByCurrentMonth = totalBookings.Count(u => u.BookingDate >= currentMounthStarDate &&
         u.BookingDate <= DateTime.Now);
        var countByPreviousMonth = totalBookings.Count(u => u.BookingDate >= previousMounthStartDate &&
         u.BookingDate <= currentMounthStarDate);
    ...
    public async Task<IActionResult> GetRegisteredUserChartData()
    {
        ...
        var countByCurrentMonth = totalUsers.Count(u => u.CreateAt >= currentMounthStarDate &&
         u.CreateAt <= DateTime.Now);
        var countByPreviousMonth = totalUsers.Count(u => u.CreateAt >= previousMounthStartDate &&
         u.CreateAt <= currentMounthStarDate);
    ...
    public async Task<IActionResult> GetRevenueChartData()
    {
        ...
        var totalRevnue = Convert.ToInt32(totalBookings.Sum(u => u.TotalCost));
        var countByCurrentMonth = totalBookings.Where(u => u.BookingDate >= currentMounthStarDate &&
        ...
        var countByPreviousMonth = totalBookings.Where(u => u.BookingDate >= previousMounthStartDate &&
         u.BookingDate <= currentMounthStarDate).Sum(u => u.TotalCost);

        return Json(GetRadialCartDataModel(totalRevnue, countByCurrentMonth, countByPreviousMonth)); 
    }
    ...
    public async Task<IActionResult> GetBookingPieChartData()
    {
        ...
        var customerWithOneBooking = totalBookings.GroupBy(b => b.UserId).Where(g => g.Count() == 1).Select(g => g.Key).ToList();
